...
const UserProfile = () => {
  ...
  const sessionInfo = actions.getSessionInfo ? actions.getSessionInfo() : null;
  ...
  return (
    <div className="user-badge-container" ref={dropdownRef}>
      ...
      <div className={`user-dropdown ${isDropdownOpen ? 'open' : ''}`}>
        ...
        {/* Session Status */}
        {state.isAuthenticated && sessionInfo && (
          <div className="session-status">
            ...
            <div className="session-details">
              <div className="session-detail">
                <span className="session-detail-label">Expires in:</span>
                <span className="session-detail-value">{sessionInfo.remainingTime}</span>
              </div>
              <div className="session-detail">
                <span className="session-detail-label">Auto-logout:</span>
                <span className="session-detail-value">{sessionInfo.expiresAt}</span>
              </div>
            </div>
          </div>
        )}
